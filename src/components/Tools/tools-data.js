...
export const tools = [
  ...
  { id: "S2", name: "Next.js", img: nextIcon, alt: "Next.js icon" },
  { id: "S3", name: "JavaScript", img: jsIcon, alt: "JavaScript icon" },
  { id: "S4", name: "HTML5", img: htmlIcon, alt: "HTML5 icon" },
  { id: "S5", name: "CSS3", img: cssIcon, alt: "CSS3 icon" },
  { id: "S6", name: "TypeScript", img: tsIcon, alt: "TypeScript Icon" },
  { id: "S7", name: "Python", img: pythonIcon, alt: "Python Icon" },
  { id: "S8", name: "Java", img: javaIcon, alt: "Java Icon" },
  { id: "S9", name: "Git", img: gitIcon, alt: "Git icon" },
  { id: "S10", name: "Redux", img: reduxIcon, alt: "Redux icon" },
  {
    id: "S11",
  ...
  { id: "S12", name: "Firebase", img: firebaseIcon, alt: "Firebase Icon" },
  {
    id: "S13",
    name: "VS Code",
    img: vsCodeIcon,
