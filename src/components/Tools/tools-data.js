...
export const tools = [
  ...
  { id: "S6", name: "Git", img: gitIcon, alt: "Git icon" },
  { id: "S7", name: "Redux", img: reduxIcon, alt: "Redux icon" },
  { id: "S8", name: "TypeScript", img: tsIcon, alt: "TypeScript Icon" },
  {
    id: "S9",
  ...
  { id: "S10", name: "Firebase", img: firebaseIcon, alt: "Firebase Icon" },
  {
    id: "S11",
    name: "VS Code",
    img: vsCodeIcon,
