...
export const tools = [
  ...
  {id: 'S2', name: 'JavaScript', img: jsIcon, alt: 'JavaScript icon'},
  {id: 'S3', name: 'HTML5', img: htmlIcon, alt: 'HTML5 icon'},
  {id: 'S4', name: 'CSS3', img: cssIcon, alt: 'CSS3 icon'},
  {id: 'S5', name: 'Git', img: gitIcon, alt: 'Git icon'},
  {id: 'S6', name: 'Redux', img: reduxIcon, alt: 'Redux icon'},
  {id: 'S7', name: 'TypeScript', img: tsIcon, alt: 'TypeScript Icon'},
  {id: 'S8', name: 'Firebase', img: firebaseIcon, alt: 'Firebase Icon'},
  {id: 'S9', name: 'VS Code', img: vsCodeIcon, alt: 'Visual Studio Code Icon'},
];
