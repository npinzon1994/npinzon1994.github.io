const timelineItems = [
  {
    ...
    duration: "1 year",
    description:
      "As a Junior React Developer, I worked as part of a team ensuring timely delivery of features made in React JS across multiple projects within an agency model.",
  },
  {
    id: 'T2',
    year: "2020",
    ...
    duration: "2 years",
    description:
      "Created and updated webpages for over 40 local school districts through a proprietary CMS, Squarespace, Blackboard, Finalsite, and Thrillshare.",
  },
  {
    id: 'T3',
    year: "2020",
  ...
  },
  {
    ...
    duration: "1 year",
    description:
      "Captured industry leads by creating the company websites for Canaan Xpress LLC, Canaan Recycling, and Millennium Fibers INC., which were made with  HTML, CSS, JavaScript, and PHP",
  },
  {
    id: 'T6',
    year: "2017",
